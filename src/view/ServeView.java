...
public class ServeView extends Stage{
	...
	public ServeView() {
		...
		this.setTitle("MysticGrill Serve");
		this.setScene(scene);
	}
	...
	private GridPane prepareForm(TableView<Order> order) {
		...
		serveButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				if(selectedMenu != null) {
					orderController.updateServeOrder(orderId);
	...
	private TableView<Order> createServeTable() {
	...
	private void LoadOrder() {
		ArrayList<Order> data = orderController.getAllPrepareOrder();
